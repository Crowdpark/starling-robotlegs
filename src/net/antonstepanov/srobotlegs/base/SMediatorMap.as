package net.antonstepanov.srobotlegs.base
{
    ...
    public class SMediatorMap extends ViewMapBase implements IMediatorMap
    {
        ...
        {
            EventDispatcher(e.target).addEventListener(starling.events.Event.REMOVED_FROM_STAGE, onStarlingViewRemoved);
        ...
        {
            EventDispatcher(e.target).removeEventListener(starling.events.Event.REMOVED_FROM_STAGE, onStarlingViewRemoved);
